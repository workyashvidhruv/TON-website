...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center font-mono relative max-w-screen overflow-x-hidden">
      ...
      {/* Live Broadcast Info */}
      <section className="w-full border-b border-foreground py-4">
        <p className="text-[14px] lg:text-[16px] uppercase tracking-wider text-center">
          Watch live: Mon | Wed | Fri at 4 PM
        </p>
      </section>

      {/* Info Section - Grid Layout */}
      <section className="container mx-auto px-4 grid lg:grid-cols-2 gap-6 w-full pt-12 pb-4">
        {/* Left Column - Info + Buttons */}
        <div className="flex flex-col gap-6">
          <p className="text-[14px] lg:text-[16px] uppercase tracking-[0.2em] text-muted">
            INFO.
          </p>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-2 text-[12px] lg:text-[14px] uppercase tracking-wider border border-foreground rounded-[40px] hover:bg-foreground hover:text-background transition-all duration-300"
            >
      ...
      <section className="w-full border-t border-b border-foreground py-6 mt-4">
        <div className="container mx-auto px-4">
          <p className="text-[14px] lg:text-[16px] uppercase tracking-[0.2em] text-muted text-center mb-6">
            made possible by
          </p>
            ...
            {siteConfig.sponsors.map((sponsor, index) => (
              <div key={sponsor.name} className="flex items-center gap-2 md:gap-6">
                ...
                {index < siteConfig.sponsors.length - 1 && (
                  <div className="w-[1px] h-8 lg:h-12 bg-neutral-200" />
                )}
              </div>
            ))}
          </div>
      ...
      <section className="w-full py-6">
        <div className="container mx-auto px-4 flex items-center justify-center gap-4">
          <p className="text-[14px] lg:text-[16px] uppercase tracking-wider">
            Livestreamed on
          </p>
          <a
            href={siteConfig.social.youtube}
      ...
      <section className="w-full py-8 border-t border-foreground">
        <div className="container mx-auto px-4 text-center">
          <p className="text-[10px] lg:text-[12px] uppercase tracking-[0.2em] text-muted leading-relaxed max-w-4xl mx-auto reveal-text">
      ...
      <section className="w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          {/* Host 1 - Utsav */}
          <div className="border-b border-foreground lg:border-b-0 lg:border-r py-8 lg:pt-16">
            <div className="container mx-auto px-4">
              <div className="flex flex-col lg:flex-row items-center lg:items-start gap-6 lg:gap-8">
                {/* Image - First on mobile, second on desktop */}
                <div className="w-[200px] h-[250px] lg:w-[300px] lg:h-[350px] order-1 lg:order-2 flex-shrink-0">
                  <Image
                    src="/hosts/utsav.png"
                    alt="Utsav Somani"
                    width={300}
                ...
                <div className="flex-1 text-center lg:text-left order-2 lg:order-1">
                  ...
                  <p className="text-[10px] lg:text-[14px] uppercase tracking-wider text-muted mb-6">
                    CEO - Offline
                  </p>
          ...
          <div className="py-8 lg:pt-16">
            <div className="container mx-auto px-4">
              <div className="flex flex-col lg:flex-row-reverse items-center lg:items-start gap-6 lg:gap-8">
                {/* Image - First on mobile, second on desktop (reversed) */}
                <div className="w-[200px] h-[250px] lg:w-[300px] lg:h-[350px] order-1 lg:order-2 flex-shrink-0">
                  <Image
                    src="/hosts/dhruv.png"
                    alt="Dhruv Sharma"
                ...
                {/* Text - Second on mobile, first on desktop (reversed) */}
      ...
      <section className="w-full border-t border-foreground py-12 lg:py-16">
        <div className="container mx-auto px-4 flex flex-col items-center gap-4 text-center">
          <p className="text-[12px] lg:text-[14px] uppercase tracking-[0.2em] text-muted">
          ...
          <Link
            href="/guests"
            className="inline-flex items-center gap-2 px-6 py-2 text-[12px] lg:text-[14px] uppercase tracking-wider border border-foreground rounded-[40px] hover:bg-foreground hover:text-background transition-all duration-300 mt-4"
          >
            explore all guests
          </Link>
        </div>
      ...
      <section className="w-full border-t border-foreground py-12 lg:py-16">
        <div className="container mx-auto px-4 text-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3 text-[12px] lg:text-[14px] uppercase tracking-wider bg-foreground text-background border border-foreground rounded-[40px] hover:bg-background hover:text-foreground transition-all duration-300"
          >
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
